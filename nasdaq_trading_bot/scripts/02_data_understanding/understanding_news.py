...
def plot_sentiment_distribution(news_df: pd.DataFrame) -> None:
    ...
    plt.tight_layout()
    out = os.path.join(IMAGES_DIR, "02_sentiment_distribution.png")
    plt.savefig(out)
    plt.close()
...
def plot_price_event_study(news_df: pd.DataFrame, index_df: pd.DataFrame) -> None:
    ...
    plt.tight_layout()
    out = os.path.join(IMAGES_DIR, "02price_event_study.png")
    plt.savefig(out)
    plt.close()
    print(f"  [OK] Saved: {out}")
...
def plot_volume_event_study(news_df: pd.DataFrame, index_df: pd.DataFrame) -> None:
    ...
    plt.grid(True, alpha=0.3)
    plt.tight_layout()
    out = os.path.join(IMAGES_DIR, "02_volume_event_study.png")
    plt.savefig(out)
    plt.close()
    print(f"  [OK] Saved: {out}")
...
def plot_trade_count_event_study(news_df: pd.DataFrame, index_df: pd.DataFrame) -> None:
    ...
    plt.grid(True, alpha=0.3)
    plt.tight_layout()
    out = os.path.join(IMAGES_DIR, "02_trade_count_event_study.png")
    plt.savefig(out)
    plt.close()
    print(f"  [OK] Saved: {out}")
...
def main():
    ...
    print("  - 02_price_event_study.png")
    print("  - 02_volume_event_study.png")
    print("  - 02_trade_count_event_study.png")
    print("=" * 60 + "\n")
